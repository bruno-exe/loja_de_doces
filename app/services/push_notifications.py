...
from ..models import DispositivoNotificacao, NotificacaoVenda, Pedido, Usuario
    ...
    with SEND_LOCK, SessionLocal() as database:
        ...
        try:
            ...
            messages = [messaging.Message(
                ...
                android=messaging.AndroidConfig(priority="high", notification=messaging.AndroidNotification(channel_id="vendas", sound="default")),
                token=device.token,
