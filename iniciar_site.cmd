...
"%VENV_PYTHON%" -c "import fastapi, uvicorn, jinja2, sqlalchemy, multipart, argon2, itsdangerous, email_validator, PIL, numpy, cv2, httpx, dotenv, pytesseract, tzdata, cryptography" >nul 2>nul
if errorlevel 1 (
